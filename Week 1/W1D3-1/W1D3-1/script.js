...
console.log("Energie van kat 1:", catBreeds[0].energy_level);
console.log("temperament kat 2:", catBreeds[1].temperament[0]);
console.log("temperament van kat 3:", catBreeds[2].temperament[4]);
console.log("favoriete eten kat 3:", catBreeds[2].food.favourite_food);
